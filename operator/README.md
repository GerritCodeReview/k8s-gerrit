...
spec:
  ...
  # - metadata:
    ...
    # spec:
      ...
      ## The mode to run Gerrit in. Options: PRIMARY (default), REPLICA
      # mode: PRIMARY
...
spec:
  ...
  ## Information about the ingress provider being used.
  ingress:
    ## Which type of Ingress provider is being used. Either: NONE, INGRESS or ISTIO
    ## (default: NONE).
    type: NONE

    ## Hostname that is used by the ingress provider.
    host: ""

    ## Whether the ingress provider that is being used has TLS enabled.
    ## (default: false)
    tlsEnabled: false
```
