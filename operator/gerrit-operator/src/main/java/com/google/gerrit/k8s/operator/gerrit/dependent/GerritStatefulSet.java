...
public class GerritStatefulSet
  ...
  protected StatefulSet desired(Gerrit gerrit, Context<Gerrit> context) {
    ...
    stsBuilder
        ...
        .withResources(gerrit.getSpec().getResources())
        .withStartupProbe(gerrit.getSpec().getStartupProbe().withPort(HTTP_PORT))
        .withReadinessProbe(gerrit.getSpec().getReadinessProbe().withPort(HTTP_PORT))
        .withLivenessProbe(gerrit.getSpec().getLivenessProbe().withPort(HTTP_PORT))
