...
public class GerritMultisiteClusterAdmissionWebhookTest extends GerritClusterAdmissionWebhookTest {
  protected ClusterMode clusterMode = ClusterMode.MULTISITE;
