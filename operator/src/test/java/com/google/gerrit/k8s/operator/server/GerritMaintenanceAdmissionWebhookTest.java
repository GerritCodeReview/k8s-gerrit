...
public class GerritMaintenanceAdmissionWebhookTest {
  ...
  public void testOnlySingleGitGcWorkingOnAllProjectsIsAllowed() throws Exception {
    GerritMaintenance gm = createGerritMaintenanceWithGitGcs(List.of(Set.of()));
    ...
    GerritMaintenance gmConflict = createGerritMaintenanceWithGitGcs(List.of(Set.of(), Set.of()));
  ...
  public void testSelectiveAndCompleteGitGcAreAllowedTogether() throws Exception {
    GerritMaintenance gm = createGerritMaintenanceWithGitGcs(List.of(Set.of(), Set.of("project1")));
  ...
  public void testNonConflictingSelectiveGcsAreAllowed() throws Exception {
    GerritMaintenance gm =
        createGerritMaintenanceWithGitGcs(List.of(Set.of("project1"), Set.of("project2")));
  ...
  public void testConflictingSelectiveGcsNotAllowed() throws Exception {
    GerritMaintenance gm =
        createGerritMaintenanceWithGitGcs(List.of(Set.of("project1"), Set.of("project1")));
    HttpURLConnection http2 = sendAdmissionRequest(gm);
  ...
  private GerritMaintenance createGerritMaintenanceWithGitGcs(List<Set<String>> projectSets) {
