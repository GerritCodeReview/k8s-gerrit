...
public class IncomingReplicationTaskTest {
  ...
  public void expectedIncomingReplicationTaskComponentsCreated(
    ...
    IncomingReplicationTaskReconciler reconciler = new IncomingReplicationTaskReconciler();
    ...
    Context<IncomingReplicationTask> context =
        new DefaultContext<IncomingReplicationTask>(
            new GenericRetryExecution(new GenericRetry()), controller, incomingReplTask);
