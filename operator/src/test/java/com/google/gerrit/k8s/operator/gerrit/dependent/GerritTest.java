...
public class GerritTest {
  ...
  public void expectedGerritComponentsCreated(
    ...
    assertEqualIgnoringOrder(stsResult, expectedSts);
    ...
    assertEqualIgnoringOrder(serviceResult, expectedService);
    ...
    assertEqualIgnoringOrder(headlessServiceResult, expectedHeadlessService);
  }
