...
public class GerritTest {
  ...
  public void expectedGerritComponentsCreated(
    ...
    assertEqualToExpectedIgnoringListOrder(stsResult, expectedSts);
    ...
    assertEqualToExpectedIgnoringListOrder(serviceResult, expectedService);
    ...
    assertEqualToExpectedIgnoringListOrder(headlessServiceResult, expectedHeadlessService);
  }
