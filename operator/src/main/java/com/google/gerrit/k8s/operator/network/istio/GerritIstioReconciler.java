...
import com.google.gerrit.k8s.operator.network.istio.dependent.GerritClusterIstioCondition;
...
import com.google.gerrit.k8s.operator.network.istio.dependent.GerritIstioSshCondition;
import com.google.gerrit.k8s.operator.network.istio.dependent.GerritIstioVirtualService;
import com.google.gerrit.k8s.operator.network.istio.dependent.GerritIstioVirtualServiceSSH;
import com.google.gerrit.k8s.operator.network.istio.dependent.ReceiverIstioCondition;
import com.google.gerrit.k8s.operator.network.istio.dependent.ReceiverIstioVirtualService;
...
public class GerritIstioReconciler
    implements GerritNetworkReconciler, EventSourceInitializer<GerritNetwork> {
