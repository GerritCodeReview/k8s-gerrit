...
public class DyanmoDbRefDbPluginConfigBuilder extends ConfigBuilder {
  public DyanmoDbRefDbPluginConfigBuilder(Gerrit gerrit) {
    super(
  ...
  private static List<RequiredOption<?>> collectRequiredOptions(Gerrit gerrit) {
    ...
    requiredOptions.add(
        new RequiredOption<String>(
            ...
            "aws-dynamodb-refdb",
            "profileName",
            gerrit.getSpec().getRefdb().getDynamoDb().getProfileName()));
