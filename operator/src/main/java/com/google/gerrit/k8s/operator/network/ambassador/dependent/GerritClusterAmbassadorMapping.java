...
/*
     ...
     kind: Mapping
     name: arlab-infra-mapping
     ambassador_id:
     - internal_proxy
     bypass_auth: false
     host: arlab.infra.corp.arista.io
     prefix: /
     service: arlab-webserver-service.arlab:80
     ---
     apiVersion: getambassador.io/v2
     kind: TLSContext
     ambassador_id:
     ...
     host_redirect: true
     prefix: /
     service: arlab.infra.corp.arista.io
...
public class GerritClusterAmbassadorMapping
  ...
  private Map<String, Object> buildSpec(GerritNetwork gerritNetwork, String serviceName) {
    ...
    spec.put("host", "gerrit-via-operator.dev.corp.arista.io");
    spec.put("prefix", "/");
