...
public class GerritIndexerVolumeRef {
  ...
  @JsonIgnore
  static GerritIndexerVolumeRef defaultForOutputVolume() {
    return new GerritIndexerVolumeRef(SharedPVC.SHARED_PVC_NAME, "shared/indexes");
  }

  @JsonIgnore
  static GerritIndexerVolumeRef defaultForSiteVolume() {
    return new GerritIndexerVolumeRef(null, null);
  }

  @JsonIgnore
  static GerritIndexerVolumeRef defaultForRepositoriesVolume() {
    return new GerritIndexerVolumeRef(SharedPVC.SHARED_PVC_NAME, "git");
  }
