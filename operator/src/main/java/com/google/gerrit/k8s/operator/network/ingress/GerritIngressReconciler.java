...
import com.google.gerrit.k8s.operator.network.ingress.dependent.GerritClusterIngressCondition;
...
public class GerritIngressReconciler implements GerritNetworkReconciler {
