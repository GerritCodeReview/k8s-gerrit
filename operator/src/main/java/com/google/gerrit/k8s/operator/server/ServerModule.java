...
public class ServerModule extends AbstractModule {
  ...
  public void configure() {
    ...
    if (clusterMode == ClusterMode.MULTISITE) {
      admissionWebhookServlets.addBinding().to(GerritMultisiteClusterAdmissionWebhook.class);
      admissionWebhookServlets.addBinding().to(GerritMultisiteAdmissionWebhook.class);
    } else {
