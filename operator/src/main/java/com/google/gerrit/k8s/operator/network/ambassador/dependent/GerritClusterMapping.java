...
public class GerritClusterMapping extends CRUDKubernetesDependentResource<Mapping, GerritNetwork> {
        ...
        new MappingBuilder()
            .withNewMetadataLike(
                Utils.getCommonMetadata(
                    gerritNetwork, GERRIT_MAPPING, this.getClass().getSimpleName()))
            .endMetadata()
            .withNewSpecLike(Utils.getCommonSpec(gerritNetwork, serviceName))
            .endSpec()
            .build();
    return mapping;
  }
