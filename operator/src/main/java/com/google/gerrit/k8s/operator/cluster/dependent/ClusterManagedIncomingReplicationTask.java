...
public class ClusterManagedIncomingReplicationTask
    extends CRUDReconcileAddKubernetesDependentResource<IncomingReplicationTask, GerritCluster>
  ...
  public IncomingReplicationTask desired(
      GerritCluster gerritCluster, Context<GerritCluster> context) {
    return new IncomingReplicationTask();
  }
  ...
  public Map<String, IncomingReplicationTask> desiredResources(
    ...
    for (IncomingReplicationTaskSpec incomingReplTaskSpec :
        primary.getSpec().getScheduledTasks().getIncomingReplTasks()) {
      IncomingReplicationTask incomingReplTask = new IncomingReplicationTask();
      incomingReplTask.setSpec(incomingReplTaskSpec);
