...
import com.google.gerrit.k8s.operator.receiver.ReceiverSpec;
...
public class ReceiverTemplate implements KubernetesResource {
  ...
  @JsonProperty("spec")
  public ReceiverSpec getSpec() {
    return spec;
  }

  @JsonProperty("spec")
  public void setSpec(ReceiverSpec spec) {
    this.spec = spec;
  }
