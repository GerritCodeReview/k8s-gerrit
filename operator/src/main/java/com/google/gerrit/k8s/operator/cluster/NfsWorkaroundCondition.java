...
public class NfsWorkaroundCondition implements Condition<ConfigMap, GerritCluster> {
  ...
  public boolean isMet(
    ...
    return gerritCluster.getSpec().getStorageClasses().getNfsWorkaround().isEnabled()
        && gerritCluster.getSpec().getStorageClasses().getNfsWorkaround().getIdmapdConfig() != null;
  }
}
