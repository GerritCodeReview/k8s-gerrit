...
public class GerritStatefulSet
  ...
  protected StatefulSet desired(Gerrit gerrit, Context<Gerrit> context) {
    ...
    stsBuilder
        ...
        .withResources(gerrit.getSpec().getResources())
        .withStartupProbe(gerrit.getSpec().getStartupProbe().forGerrit(gerrit))
        .withReadinessProbe(gerrit.getSpec().getReadinessProbe().forGerrit(gerrit))
        .withLivenessProbe(gerrit.getSpec().getLivenessProbe().forGerrit(gerrit))
