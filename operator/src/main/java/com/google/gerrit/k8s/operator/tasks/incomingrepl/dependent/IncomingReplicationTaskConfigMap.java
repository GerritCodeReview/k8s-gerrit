...
public class IncomingReplicationTaskConfigMap
  ...
  public IncomingReplicationTaskConfigMap(Class<ConfigMap> resourceType) {
    super(resourceType);
  }
  ...
  public ConfigMap desired(
    ...
    return new ConfigMapBuilder()
        ...
        .withLabels(labels)
        .endMetadata()
        .withData(Map.of("incoming-replication.config.yaml", getConfigAsString(incomingReplTask)))
        .build();
  }
