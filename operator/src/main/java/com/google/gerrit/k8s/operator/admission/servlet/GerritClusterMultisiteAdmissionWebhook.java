...
@Singleton
public class GerritClusterMultisiteAdmissionWebhook extends ValidatingAdmissionWebhookServlet {
  ...
  public GerritClusterMultisiteAdmissionWebhook() {} // TODO remove?
  ...
  public Status validate(HasMetadata resource) {
    ...
    GerritAdmissionMultisiteWebhook gerritAdmission = new GerritAdmissionMultisiteWebhook();
