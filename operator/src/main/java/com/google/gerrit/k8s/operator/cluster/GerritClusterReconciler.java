...
@ControllerConfiguration(
    dependents = {
      @Dependent(type = GitRepositoriesPVC.class, name = "git-repositories-pvc"),
      @Dependent(type = GerritLogsPVC.class, name = "gerrit-logs-pvc"),
      @Dependent(
          type = DependentGitGarbageCollectionList.class,
