...
import com.google.gerrit.k8s.operator.cluster.dependent.ClusterManagedIncomingReplicationTaskCondition;
...
@ControllerConfiguration(
    dependents = {
      ...
      @Dependent(
          ...
          reconcilePrecondition = ClusterManagedIncomingReplicationTaskCondition.class,
