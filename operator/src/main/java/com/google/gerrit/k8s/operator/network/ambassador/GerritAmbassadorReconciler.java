 ...
 * of the form `POST /my-test-repo/git-upload-pack` and the second is of the form `GET
 * /my-test-repo/info/refs?service=git-upload-pack`.
 *
 * <p>If a Receiver is part of the GerritCluster, an additional mapping is created to direct
 * `replication` (plugin) requests appropriately to the Receiver.
 */
@Singleton
