 ...
 *
 * <p>If a Receiver is part of the GerritCluster, additional mappings are created to direct
 * `replication` (plugin) requests appropriately to the Receiver. That is, all `git push` (write)
 * traffic, and all "project creation" traffic is directed to the receiver.
 */
@Singleton
