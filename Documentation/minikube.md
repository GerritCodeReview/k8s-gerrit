<<<<<<< PATCH SET (23cc9d412ae98787d4ff6d77ff995f8f0779f87e Fix documentation of minikube-based test setup)
...
||||||| BASE      (3f667d1b23cf15f346bbb1248f81f96af942724c [Operator] Update java-operator-sdk to 4.3.3)
# Running Gerrit on Kubernetes using Minikube
...
get a new IP and the `/etc/hosts`-entry has to be adjusted.
=======
>>>>>>> BASE      (3db7f2ed16b72a006633f7b92018328e7e48003b Allow cluster domain to be configured in operator)
