...
preparing the new index version outside of the Gerrit primary server. The design
of the solution depends on whether a local Lucene index or a shared index is used.
...
this job operates on an own index copy. When this job finishes, the created
...
spec:
  dataSource:
    ...
    kind: VolumeSnapshot
    name: gerrit-site-gerrit-primary-0-snapshot # Name of th eVolumeSnapshot created above
  resources:
    requests:
