...
| `data` | [`GerritModuleData`](#gerritmoduledata) | Plugin data mounted under gerrit site's `data/module name` directory |

## GerritModuleData

| Field | Type | Description |
|---|---|---|
| `secretRef` | `String` | Name of a secretRef. The secret will be mounted under |
