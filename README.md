...
pytest -v tests/container-images/base

# Run all tests in a file
pytest -v tests/container-images/base/test_container_build_base.py

# Run a specific test
pytest -v tests/container-images/base/test_container_build_base.py::test_build_base
```
