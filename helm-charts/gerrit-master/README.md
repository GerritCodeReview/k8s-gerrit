...
| `gerritMaster.plugins.core`                   | List of Gerrit core-plugins to install                                                          | `["commit-message-length-validator", "download-commands", "replication", "reviewnotes"]`                                                                                                       |
| `gerritMaster.plugins.other`                  | List of Gerrit non-core-plugins to install                                                      | `{}`                                                                                                                                                                                           |
| `gerritMaster.plugins.other[0].name`          | Name of plugin                                                                                  | `delete-project`                                                                                                                                                                               |
| `gerritMaster.plugins.other[0].url`           | Download url of plugin                                                                          | `https://gerrit-ci.gerritforge.com/view/Plugins-stable-2.16/job/plugin-delete-project-bazel-stable-2.16/lastSuccessfulBuild/artifact/bazel-genfiles/plugins/delete-project/delete-project.jar` |
| `gerritMaster.plugins.other[0].sha256`        | SHA256 sum of plugin jar used to ensure file integrity and version (optional)                   | `nil`                                                                                                                                                                                          |
