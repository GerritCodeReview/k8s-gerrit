...
| `gerritMaster.maxSurge`                       | Max. number of pods allowed to be scheduled above the desired number                            | `25%`                             |
| `gerritMaster.maxUnavailable`                 | Max. number of pods allowed to be unavailable at a time                                         | `100%`                            |
