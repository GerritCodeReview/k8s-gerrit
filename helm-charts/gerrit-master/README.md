...
| `gerritMaster.indices.type`                       | Index type used in Gerrit (either `lucene` or `elasticsearch`)                            | `lucene`                          |
| `gerritMaster.indices.lucene.persistence.enabled` | Whether to persist Lucene indices                                                         | `false`                           |
| `gerritMaster.indices.lucene.persistence.size`    | Size of persistent volume used for Lucene indices                                         | `10Gi`                            |
| `gerritMaster.indices.elasticsearch`              | Placeholder for elasticsearch options (not implemented yet)                               | `nil`                             |
