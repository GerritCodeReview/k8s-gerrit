...
| `gerrit.additionalConfigMaps`             | Allows to mount additional ConfigMaps                                                               | `[]`                                                                                     |
| `gerrit.additionalConfigMaps[*].name`     | Name of the ConfigMap                                                                               | `nil`                                                                                    |
| `gerrit.additionalConfigMaps[*].mountDir` | Directory into which the files should be symlinked                                                  | `nil`                                                                                    |
