...
| `gerrit.nodeSelector` | Assign the stateful set to specific nodes. [Assign Pods to Nodes](https://kubernetes.io/docs/tasks/configure-pod-container/assign-pods-nodes) | {} |
