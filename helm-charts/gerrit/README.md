...
| `gerrit.livenessScheme` | Scheme for liveness probe, for instance HTTPS | `nil` |
| `gerrit.readinessProbe` | Configuration of the readiness probe timings | `{initialDelaySeconds: 5, periodSeconds: 1}` |
| `gerrit.readinessScheme` | Scheme for readiness probe, for instance HTTPS | `nil` |
| `gerrit.startupProbe` | Configuration of the startup probe timings | `{initialDelaySeconds: 10, periodSeconds: 5}` |
| `gerrit.startupScheme` | Scheme for startup probe, for instance HTTPS | `nil` |
