...
| `gerritReplica.additionalConfigMaps`             | Allows to mount additional ConfigMaps                                                               | `[]`                                                                            |
| `gerritReplica.additionalConfigMaps[*].name`     | Name of the ConfigMap                                                                               | `nil`                                                                           |
| `gerritReplica.additionalConfigMaps[*].mountDir` | Directory into which the files should be symlinked                                                  | `nil`                                                                           |
