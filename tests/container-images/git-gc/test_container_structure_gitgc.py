...
def test_gitgc_contains_gc_script(docker_client, build_images):
  entrypoint = docker_client.images.get(build_images['git-gc']).attrs['ContainerConfig']['Entrypoint']
