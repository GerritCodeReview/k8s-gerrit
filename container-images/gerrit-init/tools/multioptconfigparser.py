# Workaround to make duplicate options work.
# Found at https://stackoverflow.com/questions/13921323/handling-duplicate-keys-with-configparser

import configparser
import sys

class ConfigParserMultiOpt(configparser.ConfigParser):
