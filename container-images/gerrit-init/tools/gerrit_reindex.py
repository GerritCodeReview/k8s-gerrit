...
def get_reindexer(gerrit_site_path):
    gerrit_config = GitConfigParser(
    ...
    if IndexType[index_type.upper()] is IndexType.LUCENE:
        return GerritLuceneReindexer(gerrit_site_path)

    if IndexType[index_type.upper()] is IndexType.ELASTICSEARCH:
        return GerritElasticSearchReindexer(gerrit_site_path)
...
if __name__ == "__main__":
    ...
    reindexer = get_reindexer(args.site)
